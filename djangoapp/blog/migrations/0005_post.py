    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_published', models.BooleanField(default=False, help_text='indica se o post vai poder ser acessado')),
                ('content', models.TextField()),
                ('cover', models.ImageField(blank=True, default='', upload_to='post/%Y/%m/')),
                ('cover_in_post_content', models.BooleanField(default=True, help_text='exibe a imagem de capa tambem dentro do post')),
